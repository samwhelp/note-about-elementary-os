...
> 如何 / [設定「按鍵綁定」](https://samwhelp.github.io/note-about-elementary-os/read/howto/config-keybind.html)
...
| 按鍵組合     | 功能                                 | 設定項目                                                |
| ----------- | ----------------------------------- | ----------------------------------------------------- |
| `Alt + F1`  | `開啟「應用程式啟動主選單(Main Menu)」`  | `io.elementary.desktop.wm.keybindings panel-main-menu`  |
| `Alt + F2`  | `開啟「應用程式啟動器(Runner)」`        | 目前沒有作用  |
...
| 按鍵組合           | 功能           | 執行指令           |
| ------------------ | -------------- | ------------------ |
| `Alt + Enter`      | 開啟 Terminal  | `io.elementary.terminal`  |
| `Alt + Shift + a`  | 開啟 Terminal  | `io.elementary.terminal`  |
...
| 按鍵組合           | 功能            | 執行指令                         |
| ------------------ | --------------- | -------------------------------- |
| `Alt + Shift + f`  | 開啟檔案管理器  | `io.elementary.files`             |
| `Alt + Shift + g`  | 開啟檔案管理器  | `thunar`                     |
| `Alt + Shift + e`  | 開啟文字編輯器  | `io.elementary.code`              |
| `Alt + Shift + b`  | 開啟網頁瀏覽器  | `firefox --new-tab about:blank`  |
| `Alt + Shift + s`  | 開啟系統設定    | `io.elementary.switchboard settings://input/keyboard/shortcuts`                |
...
| 按鍵組合   | 功能                  | 設定項目                            |
| ---------- | --------------------- | ----------------------------------- |
| `Win + grave`  | 切換到「所有工作空間概覽」  | `io.elementary.desktop.wm.keybindings toggle-multitasking-view`   |
